...
export const getImageBatchForAnnotating = createSelector(getImagesState, (state: ImageState, userId) => {
  return state.images.filter((image: Image) => image.processorUserId === userId);
});
